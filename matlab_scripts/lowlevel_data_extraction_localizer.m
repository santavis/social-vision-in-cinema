%% Localizer (Experiment 1): Extract lowlevel data and combine it with the mid-level semantic feature data
%
% Process
...
% Time windows where to average the data for gaze prediction analyses
...
stimulus_presentation_area_y = 1:576; % Stimulus presentation area y coordinates (within the frame)
stimulus_presentation_area_x = 1:720; % Stimulus presentation area x coordinates (within the frame)
...
xOut = setdiff(1:stimulus_frame(2),stimulus_presentation_area_x);
