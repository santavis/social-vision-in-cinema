%% Conjuring (Experiment 3): Extract lowlevel data and combine it with the mid-level semantic feature data
%
% Process
...
stimulus_presentation_area_y = 91:672; % Stimulus presentation area y coordinates (within the frame)
stimulus_presentation_area_x = 1:1000; % Stimulus presentation area x coordinates (within the frame)
